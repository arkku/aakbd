...
DEVICE_FLAGS += -DGENERIC_HID_REPORT_SIZE=32 -DGENERIC_HID_FEATURE_SIZE=16 -DGENERIC_HID_USAGE_PAGE=0xFF60U -DGENERIC_HID_USAGE=0x61 -DGENERIC_HID_INPUT_USAGE=0x62 -DGENERIC_HID_OUTPUT_USAGE=0x63 -DGENERIC_HID_HANDLE_SYNCHRONOUSLY=1 -DISO_LAYOUT=$(ISO_LAYOUT) -DSPLIT_BACKSPACE=$(SPLIT_BACKSPACE) -DSPLIT_RIGHT_SHIFT=$(SPLIT_RIGHT_SHIFT) -DSPLIT_LEFT_SHIFT=$(SPLIT_LEFT_SHIFT) -DISO_ENTER=$(ISO_ENTER) -DSPLIT_ENTER=$(SPLIT_ENTER) -DSHORT_SPACE=$(SHORT_SPACE) -DNO_PRINT

ifeq (1,$(SOLENOID_ENABLE))
DEVICE_FLAGS += -DSOLENOID_ENABLE=1 -DHAPTIC_ENABLE=1 -I$(QMK_DIR)/drivers/haptic
