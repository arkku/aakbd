...
DEVICE_OBJS = modelf.o avrusb.o keyboard.o led.o $(QMK_PLATFORM).o qmk_main.o keymap.o matrix_common.o matrix.o timer.o bitwise.o suspend.o suspend_core.o $(BOOTLOADER_TYPE).o $(DEBOUNCE_TYPE).o util_comm.o platform.o
DEVICE_FLAGS += -DGENERIC_HID_REPORT_SIZE=32 -DGENERIC_HID_FEATURE_SIZE=16 -DGENERIC_HID_USAGE_PAGE=0xFF60U -DGENERIC_HID_USAGE=0x61 -DGENERIC_HID_INPUT_USAGE=0x62 -DGENERIC_HID_OUTPUT_USAGE=0x63 -DGENERIC_HID_HANDLE_SYNCHRONOUSLY=1 -DISO_LAYOUT=$(ISO_LAYOUT) -DSPLIT_BACKSPACE=$(SPLIT_BACKSPACE) -DSPLIT_RIGHT_SHIFT=$(SPLIT_RIGHT_SHIFT) -DSPLIT_LEFT_SHIFT=$(SPLIT_LEFT_SHIFT) -DISO_ENTER=$(ISO_ENTER) -DSPLIT_ENTER=$(SPLIT_ENTER) -DSHORT_SPACE=$(SHORT_SPACE)
