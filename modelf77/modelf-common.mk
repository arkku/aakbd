...
DEVICE_OBJS = modelf.o keyboard.o led.o $(QMK_PLATFORM).o qmk_main.o keymap.o matrix_common.o matrix.o timer.o bitwise.o suspend.o suspend_core.o $(BOOTLOADER_TYPE).o $(DEBOUNCE_TYPE).o util_comm.o platform.o
