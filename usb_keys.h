...
#define MODIFIER_KEY_CTRL_LEFT      USB_KEY_LEFT_CTRL
#define MODIFIER_KEY_SHIFT_LEFT     USB_KEY_LEFT_SHIFT
#define MODIFIER_KEY_ALT_LEFT       USB_KEY_LEFT_ALT
#define MODIFIER_KEY_WIN_LEFT       USB_KEY_LEFT_WIN
#define MODIFIER_KEY_CMD_LEFT       USB_KEY_LEFT_CMD
#define MODIFIER_KEY_META_LEFT      USB_KEY_LEFT_META
#define MODIFIER_KEY_CTRL_RIGHT     USB_KEY_RIGHT_CTRL
#define MODIFIER_KEY_SHIFT_RIGHT    USB_KEY_RIGHT_SHIFT
#define MODIFIER_KEY_ALT_RIGHT      USB_KEY_RIGHT_ALT
#define MODIFIER_KEY_WIN_RIGHT      USB_KEY_RIGHT_WIN
#define MODIFIER_KEY_CMD_RIGHT      USB_KEY_RIGHT_CMD
#define MODIFIER_KEY_META_RIGHT     USB_KEY_RIGHT_META

#define MODIFIERS_START             MODIFIER_KEY_CTRL_LEFT
#define MODIFIERS_END               MODIFIER_KEY_WIN_RIGHT

#define MODIFIER_BIT(key)           (1U << ((key) - MODIFIERS_START))

#define SHIFT_BIT                   MODIFIER_BIT(MODIFIER_KEY_SHIFT_LEFT)
#define ALT_BIT                     MODIFIER_BIT(MODIFIER_KEY_ALT_LEFT)
#define ALTGR_BIT                   MODIFIER_BIT(MODIFIER_KEY_ALT_RIGHT)
#define CTRL_BIT                    MODIFIER_BIT(MODIFIER_KEY_CTRL_LEFT)
#define CMD_BIT                     MODIFIER_BIT(MODIFIER_KEY_CMD_LEFT)
#define WIN_BIT                     MODIFIER_BIT(MODIFIER_KEY_WIN_LEFT)
#define META_BIT                    MODIFIER_BIT(MODIFIER_KEY_META_LEFT)
#define RIGHT_SHIFT_BIT             MODIFIER_BIT(MODIFIER_KEY_SHIFT_RIGHT)
#define RIGHT_CTRL_BIT              MODIFIER_BIT(MODIFIER_KEY_CTRL_RIGHT)
#define RIGHT_CMD_BIT               MODIFIER_BIT(MODIFIER_KEY_CMD_RIGHT)
#define RIGHT_WIN_BIT               MODIFIER_BIT(MODIFIER_KEY_WIN_RIGHT)
#define RIGHT_META_BIT              MODIFIER_BIT(MODIFIER_KEY_META_RIGHT)
