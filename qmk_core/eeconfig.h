...
#define EECONFIG_UNICODEMODE        ((uint8_t *) 11)
#define EECONFIG_STENOMODE          ((uint8_t *) 12)
#define EECONFIG_HANDEDNESS         ((uint8_t *) 13)
#define EECONFIG_KEYBOARD           ((uint32_t *) 14)
#define EECONFIG_USER               ((uint32_t *) 18)
#define EECONFIG_HAPTIC             ((uint32_t *) 22)
#define EECONFIG_LED_MATRIX         ((uint32_t *) 26)
