/**
 * aw20216s.h: AW20216S RGB LED driver via SPI.
 *
...
#define AW20216S_PAGE_FUNCTION              0x00
#define AW20216S_PAGE_PWM                   0x01
#define AW20216S_PAGE_SCALING               0x02

// Function page registers
#define AW20216S_REG_CONFIGURATION          0x00
#define AW20216S_REG_GLOBAL_CURRENT         0x01
#define AW20216S_REG_RESET                  0x2F
#define AW20216S_REG_MIX_FUNCTION           0x46
#define AW20216S_RESET_MAGIC                0xAE

#define AW20216S_CONFIGURATION_SWSEL_1_12   0xB0
#define AW20216S_CONFIGURATION_CHIPEN       1
#define AW20216S_CONFIGURATION              (AW20216S_CONFIGURATION_SWSEL_1_12 | AW20216S_CONFIGURATION_CHIPEN)

#define AW20216S_MIX_FUNCTION_LPEN          (1 << 1)
...
// AW20216S SPI command format
#define AW20216S_ID                         0xA0
#define AW20216S_WRITE                      0
#define AW20216S_READ                       1

/// One RGB LED mapping within the AW20216S register space
typedef struct {
    uint8_t driver_index;  // 0 = CS1 (B13), 1 = CS2 (B14)
    uint8_t reg_r;         // PWM register address for red channel
    uint8_t reg_g;         // PWM register address for green channel
    uint8_t reg_b;         // PWM register address for blue channel
} aw20216s_led_t;
...
// AW20216S register address constants
#define SW1_CS1 0x00
#define SW1_CS2 0x01
#define SW1_CS3 0x02
#define SW1_CS4 0x03
